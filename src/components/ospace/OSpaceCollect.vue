            ...
            <div id="page-video" class="wrapper">
                <div class="col-full clearfix">
                    ...
                    <div class="main-content">
                        <OCollectList :videoList="videoList" v-on:changePage="getData" :total="total"></OCollectList>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        getTotal() {
            spaceApi.favTotal(this.userId).then((response) => {
        ...
        getNewCollect() {
            spaceApi.spaceFav({ 'userId': this.userId, 'pageNum': this.pageNum, 'pageSize': this.pageSize }).then((response) => {
                this.videoList = response.list
                this.total = response.total
            })
        },
        getMostPlay() {
            spaceApi.favMostPlay({ 'userId': this.userId, 'pageNum': this.pageNum, 'pageSize': this.pageSize }).then((response) => {
                this.videoList = response.list
                this.total = response.total
            })
        },
        getNewUpload() {
            spaceApi.newUpload({ 'userId': this.userId, 'pageNum': this.pageNum, 'pageSize': this.pageSize }).then((response) => {
                this.videoList = response.list
                this.total = response.total
            })
        },
