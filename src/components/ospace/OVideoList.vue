...
export default {
    ...
    methods: {
        ...
        getMostPlay() {
            spaceApi.mostPlay({ 'userId': this.userId, 'pageNum': this.pageNum, 'pageSize': this.pageSize}).then((response) => {
                this.videoList = response.list
                this.total = response.total
            })
        },
        getMostCollect() {
            spaceApi.mostCollect({ 'userId': this.userId, 'pageNum': this.pageNum, 'pageSize': this.pageSize}).then((response) => {
                this.videoList = response.list
                this.total = response.total
            })
        },
