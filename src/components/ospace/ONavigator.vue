        ...
        <div class="wrapper">
            <div class="n-inner clearfix">
                <div class="n-tab-links">
                    <a :href="'/ospace/index?id='+userInfo.id" class="n-btn n-index n-fans n-404 router-link-exact-active router-link-active" :class="active === 'index' ? 'active' : ''">
                        <span class="iconfont icon-ic_home"></span>
                        <span class="n-text">主页</span>
                    </a>
                    <!-- dynamic -->
                    <a href="#" class="n-btn n-dynamic">
                        <span class="iconfont icon-ic_following"></span>
                        <span class="n-text">动态</span>
                    </a>
                    <!-- video -->
                    <a :href="'/ospace/video?id='+userInfo.id" class="n-btn n-video n-audio n-article n-album" :class="active === 'video' ? 'active' : ''">
                        <span class="iconfont icon-ic_video"></span>
                        <span class="n-text">投稿</span>
                    </a>
                    <!-- favlist -->
                    <a :href="'/ospace/fav?id='+userInfo.id" class="n-btn n-favlist" :class="active === 'fav' ? 'active' : ''" v-show="userInfo.collect_state === 0">
                ...
                <div class="n-statistics">
                    <a :href="'/ospace/follow/attention?id='+userInfo.id" class="n-data n-gz" title="0">
                        <p class="n-data-k">关注数</p>
                        <p id="n-gz" class="n-data-v space-attention">{{userInfo.attention}}</p>
                    </a>
                    <a :href="'/ospace/follow/fans?id='+userInfo.id" class="n-data n-fs" title="0">
